...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try {
        await axios.post(`http://localhost:3333/${data.game}/ads`, {
            name: data.name,
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <select
              id="game"
              name="game"
              placeholder="Selecione qual o jogo que deseja jogar?"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="name">Seu nome (ou nickman)</label>
            <Input
              id="name"
              name="name"
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="discord">ual o seu Discord?</label>
